...
function setup() {
  ...
  pendulum2 = new Pendulum(400, 450, "indigo");
  pendulum3 = new Pendulum(460, 450, "blue");
  pendulum4 = new Pendulum(520, 450, "green");
  pendulum5 = new Pendulum(580, 450, "yellow");
  pendulum6 = new Pendulum(640, 450, "orange");
  pendulum7 = new Pendulum(700, 450, "red");
  ...
  sling7 = new Sling(pendulum7.body,{x : 700, y : 200});  
}
